...
import { ArrowLeft, FileText, Download, CheckCircle2, XCircle, Building2, Calendar, User as UserIcon, Hash, IndianRupee, Briefcase, ExternalLink, ChevronLeft, ChevronRight, ZoomIn, ZoomOut, Loader2, Landmark, Wallet} from "lucide-react";
  ...
  useEffect(() => {
    ...
    const loadPdf = async () => {
      try {
        ...
        const pdfUrl = getApiUrl(
  `/api/pdf/payment?paymentNo=${encodeURIComponent(paymentNo)}`
);
