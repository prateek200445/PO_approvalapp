...
builder.Services.AddSingleton<PresentationRulesService>();
builder.Services.AddSingleton<WorkbookPresentationRulesExtractor>();
...
builder.Services.AddSingleton<FinancialStatementTemplateExporter>();
builder.Services.AddScoped<FinancialStatementService>();
builder.Services.AddScoped<FinancialStatementOutputLogger>();
